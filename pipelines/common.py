...
class DatasetMixin:
    ...
    a dataset, including neuroimaging and molecular datasets.
    """
    ...
    def load_dataset(self, dataset_type="general"):
        """Load and prepare the dataset based on the type specified."""
        import numpy as np
